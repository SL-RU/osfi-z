...
// объ€вл€ем видимость функций
	.global xmp3_PolyphaseStereo
	.global xmp3_PolyphaseMono

// нужно дл€ использовани€ расширенного синтаксиса
	.syntax unified

#define USE_CORTEX_M4

// нека€ константа
.equ	RNDVAL, (1 << ((32 - 12) + (6 - 1)))

// именуем рабочие регистры
...
.macro	C64TOS	xl, xh, sign, maxPos
    mov        \xl, \xl, lsr #(20+6)		// xl = xl >> 26 - старшие 6 бит сдвинуть вниз до 0 бита
    orr        \xl, \xl, \xh, lsl #(12-6)	// xl = xl | (xh << 6)
#ifndef USE_CORTEX_M4
    mov        \sign, \xl, ASR #31			// sign = xl >> 31 - вз€ть старший бит
    cmp        \sign, \xl, ASR #15			// сравнить sign и (xl >> 15)
    it ne									// if <> then выполнить следующую команду {}
