...
static __inline unsigned short btss_swap16(unsigned short value)
/*
...
static __inline unsigned long btss_swap32(unsigned long value)
/*
...
*/
{
	unsigned long hi = btss_swap16(value >> 16);
	unsigned long lo = btss_swap16(value & 0xffff);
...
static __inline int unaligned32_be(const void *v){
	return btss_betoh32(unaligned32(v));  // original
}

static __inline int unaligned32_le(const void *v){
	return btss_letoh32(unaligned32(v));  // original
}
